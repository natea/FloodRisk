...
class TestLisfloodSimulator:
    ...
    def test_simulator_initialization(self, mock_executable):
        ...
        simulator = LisfloodSimulator(
            lisflood_executable=mock_executable,
            working_directory="test_runs"
        )
    ...
    def test_simulation_execution_success(self, mock_run, mock_executable, temp_files):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch.object(simulator, '_load_lisflood_output', return_value=depth_data):
...
class TestParameterFileGenerator:
    ...
    def test_hyetograph_generation(self):
        ...
        assert len(hyetographs) >= 3  # uniform, front_loaded, center_loaded, back_loaded
...
class TestResultProcessor:
    ...
    def test_statistics_calculation(self, mock_depth_data):
        ...
        required_keys = [
            'total_pixels', 'flooded_pixels', 'flood_fraction',
            'max_depth_m', 'mean_depth_all_m', 'mean_depth_flooded_m'
        ]
...
class TestSimulationValidator:
    ...
    def test_batch_validation(self):
        ...
        batch_summary = validator.validate_batch_results(sim_results, detailed_validation=False)
...
class TestSimulationBatch:
    ...
    def test_batch_creation_from_config(self, mock_simulator, mock_param_generator, tmp_path):
...
class TestFullPipeline:
    ...
    def test_end_to_end_pipeline(self, tmp_path):
        ...
        return_periods = ParameterFileGenerator.create_standard_return_periods()[:2]  # Just 2 for testing
