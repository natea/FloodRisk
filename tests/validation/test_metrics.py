...
class TestClassificationMetrics:
    ...
    def test_all_positive_predictions(self):
        ...
        assert result['false_positives'] == 2  # But also predicted negatives as positive
...
class TestMetricsCalculator:
    ...
    def test_individual_metric_methods(self):
        ...
        class_result = self.calc.calculate_classification_metrics(predictions, observations)
...
class TestUtilityFunctions:
    ...
    def test_calculate_flood_extent_metrics(self):
        ...
        extent_metrics = calculate_flood_extent_metrics(
            depth_predictions, depth_observations, 
...
def test_integration_with_sample_data(sample_flood_data):
    ...
    assert all(category in results for category in ['iou', 'regression', 'classification', 'csi'])
