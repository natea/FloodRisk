...
class TestBaseDataSource:
    ...
    def test_cache_key_generation(self):
        ...
        key2 = source._generate_cache_key(param2=123, param1="value1")  # Same params, different order
        key3 = source._generate_cache_key(param1="value2", param2=123)  # Different value
...
class TestNOAAAtlas14Fetcher:
    ...
    def test_duration_conversion(self):
        ...
        assert fetcher.config_durations_min == [int(h * 60) for h in fetcher.config.durations_hours]
    ...
    def test_validate_data_integrity(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            results = manager.validate_data_integrity(
                [valid_file, invalid_file, missing_file],
                data_type="test"
            )
