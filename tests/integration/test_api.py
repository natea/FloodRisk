...
def mock_app():
    ...
    def predict_flood_depth(request: PredictionRequest):
        ...
        return PredictionResponse(
            flood_depth=flood_depth, confidence=0.85, processing_time=1.2
        )
...
class TestPredictionEndpoint:
    ...
    def test_predict_with_invalid_data(self, client):
        ...
        invalid_requests = [
            ...
            {"rainfall_data": [1.0, 2.0], "terrain_features": {"slope": [[0.1]]}},
